...
@section('title', 'Create Other Expense')

@section('content_header')
<div class="row justify-content-center">
    <div class="col-12 col-md-12 text-center">
    <h1>Create new Other Expense</h1>
    <div class="row justify-content-center">
...
@section('content')
    <div class="row justify-content-center">
    <div class="col-12 col-md-12 text-center">
    <p>From here you can add new other Expense.</p>
    <div class="row justify-content-center">
                ...
                <form action="created" method="POST" class="mt-4">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-md-3">
                            ...
                            <input type="number" class="form-control" placeholder="0.00" step="any" name="unit_price" id="unit_price" tabindex="3" required>
                        </div>
                    </div>
