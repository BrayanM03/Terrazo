...
@section('content')
    <div class="row justify-content-center">
    <div class="col-12 col-md-12 text-center">
    <p>From here you can add a new customer.</p>
    <div class="row justify-content-center">
                ...
                <form action="created" method="POST" class="mt-4">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-md-6">
                            ...
                            <textarea type="text" class="form-control" placeholder="Type customer's address" name="address" id="address" tabindex="2" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-md-3">
                            ...
                            <input type="text" class="form-control" placeholder="Type customer's number" name="number" id="number" tabindex="3">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-md-3">
                            ...
                            <input type="text" class="form-control" placeholder="Type customer's email" name="email" id="number" tabindex="3">
                        </div>
                    </div>
